...
class DatasetAnalysis():
    ...
    def Topic_distribution(self):
     ...
     #    # print("=" * 30)
          ...
          plt.title('Percentage Topic Distribution')      #orignal name:  Gender distribution     20210505
          plt.tight_layout()
    ...
    def Most_Popular_Topics(self):
        ...
        plt.title('Frequently Read Topics') #rename it: plt.title('Most Popular Topics') 20210505
...
################################################################################################################
    def Gender_distribution_language(self):
        ...
        #debug on 20210505
        if not french_speaker.empty:
          french_labels, french_values = zip(*french_gender_counter.items())
        else:
          french_labels=('Male', 'Female') 
          french_values=(0,0)
        #end above debug on 20210505

        print(f'type french_speaker:{type(french_speaker)}')  
        #english_labels:('Male', 'Female'),english_values:(8, 3)
        print(f'french_labels:{french_labels}')
        print(f'french_values:{french_values}')
        ...
        #debug on 20210505
        if not english_speaker.empty:
          english_labels, english_values = zip(*english_gender_counter.items())
        else:
          english_labels=('Male', 'Female') 
          english_values=(0,0)
        #end above debug on 20210505

        print(f'english_labels:{english_labels}')
        print(f'english_values:{english_values}')
        ...
        plt.title('English speakers gender distribution')       #Gender Distribution English Speakers
        plt.tight_layout()
        ...
        #debug on 20210505
        if french_speaker.empty:
            french_gender_dis_fig=None
        if english_speaker.empty:
            english_gender_dis_fig=None
    ...
    def Visual_Gender_Bar(self):
        ...
        plt.title("Gender Distribution by Languages")        # orignal name: Visual Gender Bar 20210505
        plt.tight_layout()
        # plt.show()
    ...
    def ItemsGenderSpecific(self):
        ...
        plt.title('Items Gender Specific')      #name it on 20210505
        plt.tight_layout()
    ...
    def MostViewedTopic_Based_on_roles(self):
        ...
        # plt.show()
        plt.title("Viewed Topics Based on Roles ")       #orignal name: MostViewedTopic Based On Roles
        plt.tight_layout()
        uri = self.getBase64URI(plt.gcf())
        plt.clf()
